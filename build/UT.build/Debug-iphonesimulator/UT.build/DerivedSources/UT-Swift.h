...
SWIFT_CLASS("_TtC2UT11AppDelegate")
...
SWIFT_CLASS("_TtC2UT14ViewController")
@interface ViewController : UIViewController <UIScrollViewDelegate, UITextViewDelegate, UIPickerViewDelegate>
@property (nonatomic, weak) IBOutlet UITextView * __null_unspecified input;
@property (nonatomic, weak) IBOutlet UIPickerView * __null_unspecified picker;
@property (nonatomic, weak) IBOutlet UITextView * __null_unspecified gg_output;
...
@property (nonatomic, copy) NSArray<NSString *> * __nonnull lang;
